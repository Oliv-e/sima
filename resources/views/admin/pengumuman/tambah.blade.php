<x-app-layout>
    ...
    <div class="pt-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <form id="formId" action="{{route('pengumuman.insert')}}" method="POST">
                        @csrf
                        <div class="my-2">
                            <x-input-label for="isi_pengumuman" :value="__('Isi Pengumuman')" />
                            <x-text-input required id="isi_pengumuman" type="text" name="isi_pengumuman" value="{{old('isi_pengumuman')}}" class="mt-1 bg-green-100 block w-full" />
                        </div>
